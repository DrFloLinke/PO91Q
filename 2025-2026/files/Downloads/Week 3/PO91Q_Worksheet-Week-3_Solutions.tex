...
Quantitative Research Methods}}
                  ...
                  \par\vspace{1ex}%
          {\textsc{\fontsize{11}{12}\selectfont Worksheet Week 3 -
Solutions}}
...
\section*{Exercises -- Calculations}\label{exercises-calculations}
\addcontentsline{toc}{section}{Exercises -- Calculations}
...
\item
  Billy is looking for the heaviest bag possible and finds one that is
  1082 g. What is the probability of finding a heavier bag?\\
  \strut ~\\
...
\item
  What is the probability that Billy will find a bag lighter than
  870g?\\
  \strut ~\\
  \(\color{waraubergine}\mu = 1000\)\\
  \(\color{waraubergine}\sigma = 50\)\\
...
\tightlist
\item
  How would the results of a. and b. change if the standard deviation
  was only 40g?\\
  \strut ~\\
...
\item
  12.92\% \vspace{0.25cm}
\item
  \(\frac{50-62.3}{8.5}=-1.447059\) \(\rightarrow\) 7.35\%
\end{enumerate}

\section*{R Exercises}\label{r-exercises}
\addcontentsline{toc}{section}{R Exercises}

See RScript in the
\href{https://drflolinke.github.io/PO91Q/11-Downloads.html}{Online
Companion}
